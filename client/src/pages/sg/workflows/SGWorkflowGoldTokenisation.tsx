...
const STEPS: WorkflowStep[] = [
  ...
  },
  {
    ...
    details: [
      ...
      "Live pricing: LBMA Fix (10:30/15:00 London) + SBMA/KIS daily benchmark as NAV anchor",
      "Price alignment: DBS as issuer arbitrages divergence by minting (if premium) or redeeming (if discount) tokets against physical gold, identical to GLD/SPDR Gold Trust AP mechanism",
      "Cross-venue arbitrage: Traders arbitrage VANDA gold tokets against COMEX, Shanghai Gold Exchange, and LBMA, keeping prices within 0.1-0.3% of spot",
      "Options: Trade, Pledge, Lend, Redeem (cash or physical)",
      "Redemption Tier 1 (Institutional): Authorised Participants redeem large blocks (100+ oz) for physical gold from LBMA vaults via DBS Precious Metals desk",
      "Redemption Tier 2 (Retail): End-investors redeem for cash (SGD/XSGD) at NAV minus 0.25% fee; DBS manages physical inventory at aggregate level",
      "Physical small-bar option: DBS offers 100g/1oz bar redemption as a value-added service through its precious metals desk",
    ],
    systemState: { "Investors": "5 end-investors", "Total Held": "1,000 grams", "Smallest Position": "150 grams", "Register": "UNITS|SG Direct", "Price Ref": "LBMA Fix + SBMA/KIS", "Redemption": "2-tier (physical + cash)" },
  ...
  },
  {
    ...
    details: [
      ...
      "Physical redemption: Ahmad redeems 150 grams (Tier 1 institutional via DBS)",
      ...
      "Management fee: 0.40% p.a. charged in-kind (gold deduction, not cash). Token Program accrues daily (0.40%/365), sweeps periodically by reducing gold backing per toket, identical to GLD/SPDR Gold Trust mechanism",
      "Fee flow: Pre-hook validates accrual calculation, state mutation adjusts backing ratio, post-hook emits fee event for audit. No cash or XSGD needed",
      "All operations recorded on UNITS|SG with full audit trail",
      "IPM GST exemption maintained throughout lifecycle",
    ],
    systemState: { "Collateral Pledged": "100g (Wei Lin)", "Transferred": "50g (James)", "Redeemed": "150g (Ahmad)", "Remaining Active": "700g", "Mgmt Fee": "0.40% p.a. in-kind" },
